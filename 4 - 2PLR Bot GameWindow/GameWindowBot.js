document.addEventListener('DOMContentLoaded', () => {
    ...
    //BLOCK/GAME INITIALISATION_________________________________________________________________________________________________
        ...
        function blockCheck(unconditional){
            ...
            document.getElementById("ExportScoreP2").innerHTML = (score);
            blocksToClear = [];
            gravityCheck = [];
            ...
            if(clearing == true){
                ...
                decisionMaking(); //Needs to make the computer decision before drawing the new block              
            }
        }
    ...
    //GAME OFF WINDOW FUNCTIONS_________________________________________________________________________________________________
        ...
        function gameOver() { //Game Over Functionality
            ...
            if(gameOverTrue == true || document.getElementById("ExportScoreP1").innerHTML == ("Player 2 Wins")){
                document.getElementById("ExportScoreP2").innerHTML = ("Player 1 Wins")
                gamePause();
